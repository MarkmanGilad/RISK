...
def _write_json(path: Path, value: dict[str, Any]) -> None:
    """Write a complete replacement file, so an interrupted game is resumable."""
...
def main() -> None:
    ...
    AGENT_KIND = "DQN"
    RUN_ID = 103
    MIN_EPISODE = 6_200  # Set to None to include every earlier checkpoint.
    MAX_EPISODE = 6_700  # Set to None to include every later checkpoint.
    USE_WANDB = True
